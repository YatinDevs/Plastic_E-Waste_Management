        ...
        <div class="container text-center text-md-left">
          <div class="row text-center text-md-left">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
              ...
              <p>
                <i class="fa fa-home mr-3"></i> Mumbai,Maharashtra.
              </p>
              <p>
                <i class="fa fa-envelope mr-3"></i>zerowaste727@gmail.com
              </p>
              <p>
                <i class="fa fa-phone mr-3"></i>+91 9594515799
              </p>
              <p>
                <i class="fa fa-phone mr-3"></i>+91 9921355106
              </p>
            </div>
          </div>
          ...
          <div class="row align-items-center">
            <div class="col-md-7 col-lg-12 m-auto">
              <p>
                ...
                <a href="#">
                  <strong class="text-warning"> ZeroWaste CDAC-Noida</strong>
                </a>
              </p>
            </div>
          </div>
