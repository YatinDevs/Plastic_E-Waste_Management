  ...
  return (
    <div>
      <div class="bg-dark text-right p-2 row">
        <div class="col-lg-8">
          <h3 class="text-white me-5 pe-5 fw-bold">Terms and Conditons</h3>
        </div>
        <div class="col-lg-4">
          <Link
            to="/register"
            class="btn btn-lg btn-primary me-5 ps-5 pe-5 p-2"
          >
            Back
          </Link>
        </div>
      ...
      <div>
        <nav class="mr-md-5 ml-md-5 mb-1 mt-5 display-4 text-center">
